...
type FooInterface interface {
	Create(*api.Foo) (*api.Foo, error)
	Update(*api.Foo) (*api.Foo, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*api.Foo, error)
	List(opts v1.ListOptions) (*api.FooList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *api.Foo, err error)
	FooExpansion
}
...
func newFoos(c *CoreClient, namespace string) *foos {
	return &foos{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *foos) Create(foo *api.Foo) (result *api.Foo, err error) {
	result = &api.Foo{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Update(foo *api.Foo) (result *api.Foo, err error) {
	result = &api.Foo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Get(name string, options v1.GetOptions) (result *api.Foo, err error) {
	result = &api.Foo{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) List(opts v1.ListOptions) (result *api.FooList, err error) {
	result = &api.FooList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *api.Foo, err error) {
	result = &api.Foo{}
