...
type FooLister interface {
	...
	List(selector labels.Selector) (ret []*api.Foo, err error)
...
// List lists all Foos in the indexer.
func (s *fooLister) List(selector labels.Selector) (ret []*api.Foo, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*api.Foo))
	})
	return ret, err
}
...
// List lists all Foos in the indexer for a given namespace.
func (s fooNamespaceLister) List(selector labels.Selector) (ret []*api.Foo, err error) {
...
// Get retrieves the Foo from the indexer for a given namespace and name.
func (s fooNamespaceLister) Get(name string) (*api.Foo, error) {
