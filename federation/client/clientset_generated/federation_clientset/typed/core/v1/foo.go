...
type FooInterface interface {
	...
	Get(name string, options meta_v1.GetOptions) (*v1.Foo, error)
	List(opts meta_v1.ListOptions) (*v1.FooList, error)
...
func newFoos(c *CoreV1Client, namespace string) *foos {
	return &foos{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *foos) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *foos) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Get(name string, options meta_v1.GetOptions) (result *v1.Foo, err error) {
	result = &v1.Foo{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) List(opts meta_v1.ListOptions) (result *v1.FooList, err error) {
	result = &v1.FooList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("foos").
